...
class SafeSafaiCircularLoader extends StatelessWidget {
  ...
  const SafeSafaiCircularLoader({
    super.key,
    this.foregroundColor = SafeSafaiColors.white,
    this.backgroundColor = SafeSafaiColors.primary,
  });
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: const EdgeInsets.all(SafeSafaiSizes.lg),
