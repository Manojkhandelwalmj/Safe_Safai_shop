...
class SafeSafaiTextTheme{
  SafeSafaiTextTheme._();
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    headlineSmall: const TextStyle().copyWith(fontSize: 18.0, fontWeight: FontWeight.w200, color: Colors.black),
    ...
    titleSmall: const TextStyle().copyWith(fontSize: 16.0, fontWeight: FontWeight.w200, color: Colors.black),
    ...
    bodySmall: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.w200, color: Colors.black.withOpacity(0.5)),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    titleSmall: const TextStyle().copyWith(fontSize: 16.0, fontWeight: FontWeight.w200, color: Colors.white),

    bodyLarge: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.bold, color: Colors.white),
    bodyMedium: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.w600, color: Colors.white.withOpacity(0.5)),
    bodySmall: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.w200, color: Colors.white),
